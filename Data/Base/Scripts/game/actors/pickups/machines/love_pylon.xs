...
[
	Placeable(true), 
	Name("Love pylon Pickup"), 
	Description("Base class for love pylon pickup logic.") 
]
public class Love_Pylon_Pickup : Pickup
{	
	protected string Pickup_Sprite		= "actor_pickups_love_pylon_0";
	protected string Pickup_Name		= Locale.Get("#item_love_pylon_name");
	protected string Pickup_Sound		= "sfx_objects_pickups_turret_pickup";
	protected Type	 Weapon_Type		= typeof(Weapon_Love_Pylon);
