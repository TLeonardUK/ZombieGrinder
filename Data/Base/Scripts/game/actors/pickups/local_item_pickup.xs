...
[
	Placeable(false), 
	Name("Local Item Pickup"), 
	Description("Base class for inventory item pickup logic, that is non-replicated and exists purely on the client.") 
]
public class Local_Item_Pickup : Local_Pickup
{	
