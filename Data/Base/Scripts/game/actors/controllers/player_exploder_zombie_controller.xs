...
[
	Name("Player Exploder Zombie Controller"), 
	Description("Allows players to control an exploder zombie!") 
]
public class Player_Exploder_Zombie_Controller : Player_Generic_Zombie_Controller
{
