...
[
	Name("Player Small Blobby Zombie Controller"), 
	Description("Allows players to control a small blobby zombie!") 
]
public class Player_Small_Blobby_Zombie_Controller : Player_Generic_Zombie_Controller
{
	...
	Player_Small_Blobby_Zombie_Controller()
	{
