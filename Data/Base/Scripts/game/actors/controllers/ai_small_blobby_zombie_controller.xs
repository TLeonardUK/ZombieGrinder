...
[
	Name("AI Small Blobby Zombie Controller"), 
	Description("Controls poison cloud zombies using some simple run-at-the-closest-player AI.") 
]
public class AI_Small_Blobby_Zombie_Controller : Pawn_Controller
{
	// -------------------------------------------------------------------------
	...
	AI_Small_Blobby_Zombie_Controller()
	{
	...
	state Idle
	{
		...
		event void On_Tick()
		{
			...
			{
				Pawn pawn = Possessed;
				Small_Blobby_Zombie zombie = <Small_Blobby_Zombie>pawn;
