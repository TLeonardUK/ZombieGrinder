...
public class Challenge_Rare_XP_Drop_Table : Drop_Table
{
	Challenge_Rare_XP_Drop_Table()
	{
		Drop_Probability = 1.0f; 
		
        // Coin bags!
		Add(typeof(Item_Medium_XP_Grab_Bag), 5);
		Add(typeof(Item_Large_XP_Grab_Bag), 5);
	}
}