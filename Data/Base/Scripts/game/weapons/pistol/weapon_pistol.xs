...
[
	Name("Weapon Pistol"), 
	Description("Standard issue sidearm! Basic plinker.") 
]
public class Weapon_Pistol : Projectile_Weapon
{		
	Weapon_Pistol()
	{
		Name = Locale.Get("#item_pistol_name");
		...
		Item_Type 				= Item_Archetype.Find_By_Type(typeof(Item_Pistol));

		// Projectile specific settings.
		Muzzle_Effect			= "pistol_fire";
		Is_Automatic			= false;
