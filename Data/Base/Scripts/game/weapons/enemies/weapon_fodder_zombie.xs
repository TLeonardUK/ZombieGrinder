...
[
	Name("Weapon Fodder Zombie"), 
	Description("Claws for the fodder zombie.") 
]
public class Weapon_Fodder_Zombie : Projectile_Weapon
{		
	Weapon_Fodder_Zombie()
	{
		// This weapon does jack shit, the exploder zombies hook into the fire event and blow
		// up when you try to, so this is sorta just here as a dummy.
		
		Name = "<internal_weapon>";

		Walk_Animation 	= "";
		Fire_Animation	= "enemy_fodder_zombie_attack";
		...
		Muzzle_Effect			= "fodder_zombie_slash";
		Is_Automatic			= false;
	}
}
