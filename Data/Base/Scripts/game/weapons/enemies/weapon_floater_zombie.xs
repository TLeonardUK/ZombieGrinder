...
[
	Name("Weapon Floater Zombie"), 
	Description("Blood clots for the floater zombie.") 
]
public class Weapon_Floater_Zombie : Projectile_Weapon
{		
	Weapon_Floater_Zombie()
	{
		...
		Muzzle_Effect			= "floater_zombie_fire";
		Is_Automatic			= false;
	}
}
