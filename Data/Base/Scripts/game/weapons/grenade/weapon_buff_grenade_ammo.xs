...
[
	Name("Buff Grenade Ammo"), 
	Description("AOE grenade that increases users ammo.") 
]
public class Weapon_Buff_Grenade_Ammo : Projectile_Weapon
{	
	Weapon_Buff_Grenade_Ammo()
	{
		Name = Locale.Get("#item_buff_grenade_health_name");

		Walk_Animation 	= "avatar_body_ammocapacity_grenade";
		Fire_Animation	= "avatar_body_ammocapacity_grenade_fire";
		...
		HUD_Icon				= "game_hud_weaponicon_buff_grenade_ammo";
		HUD_Ammo_Icon			= "game_hud_ammoicon_buff_grenade_ammo";
		
		Fire_Sound				= "sfx_objects_weapons_buff_grenade_fire";
		
		AI_Priority				= 0.1f;

		Item_Type 				= Item_Archetype.Find_By_Type(typeof(Item_Buff_Grenade_Ammo));
		
		// Projectile specific settings.
		Muzzle_Effect			= "buff_grenade_ammo_fire";
		Is_Automatic			= false;
