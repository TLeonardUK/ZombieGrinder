...
[
	Name("Buff Grenade XP"), 
	Description("AOE grenade that increases users XP gain.") 
]
public class Weapon_Buff_Grenade_XP : Projectile_Weapon
{	
	Weapon_Buff_Grenade_XP()
	{
		Name = Locale.Get("#item_buff_grenade_xp_name");

		Walk_Animation 	= "avatar_body_xp_grenade";
		Fire_Animation	= "avatar_body_xp_grenade_fire";
		...
		HUD_Icon				= "game_hud_weaponicon_buff_grenade_xp";
		HUD_Ammo_Icon			= "game_hud_ammoicon_buff_grenade_xp";
		
		Fire_Sound				= "sfx_objects_weapons_buff_grenade_fire";
		
		AI_Priority				= 0.1f;

		Item_Type 				= Item_Archetype.Find_By_Type(typeof(Item_Buff_Grenade_Xp));

		// Projectile specific settings.
		Muzzle_Effect			= "buff_grenade_xp_fire";
		Is_Automatic			= false;
