...
[
	Name("Buff Grenade Speed"), 
	Description("AOE grenade that increases users speed.") 
]
public class Weapon_Buff_Grenade_Speed : Projectile_Weapon
{	
	Weapon_Buff_Grenade_Speed()
	{
		Name = Locale.Get("#item_buff_grenade_speed_name");

		Walk_Animation 	= "avatar_body_speed_grenade";
		Fire_Animation	= "avatar_body_speed_grenade_fire";
		...
		HUD_Icon				= "game_hud_weaponicon_buff_grenade_speed";
		HUD_Ammo_Icon			= "game_hud_ammoicon_buff_grenade_speed";
		
		Fire_Sound				= "sfx_objects_weapons_buff_grenade_fire";
		
		AI_Priority				= 0.1f;

		Item_Type 				= Item_Archetype.Find_By_Type(typeof(Item_Buff_Grenade_Speed));

		// Projectile specific settings.
		Muzzle_Effect			= "buff_grenade_speed_fire";
		Is_Automatic			= false;
