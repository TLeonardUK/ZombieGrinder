...
[
	Name("Buff Grenade ROF"), 
	Description("AOE grenade that increases users ROF.") 
]
public class Weapon_Buff_Grenade_ROF : Projectile_Weapon
{	
	Weapon_Buff_Grenade_ROF()
	{
		Name = Locale.Get("#item_buff_grenade_rof_name");

		Walk_Animation 	= "avatar_body_rof_grenade";
		Fire_Animation	= "avatar_body_rof_grenade_fire";
		...
		HUD_Icon				= "game_hud_weaponicon_buff_grenade_rof";
		HUD_Ammo_Icon			= "game_hud_ammoicon_buff_grenade_rof";
		
		Fire_Sound				= "sfx_objects_weapons_buff_grenade_fire";
		
		AI_Priority				= 0.1f;

		Item_Type 				= Item_Archetype.Find_By_Type(typeof(Item_Buff_Grenade_Rof));
		
		// Projectile specific settings.
		Muzzle_Effect			= "buff_grenade_rof_fire";
		Is_Automatic			= false;
