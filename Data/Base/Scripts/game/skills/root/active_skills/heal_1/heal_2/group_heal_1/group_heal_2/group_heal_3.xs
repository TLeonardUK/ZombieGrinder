...
public class Skill_Group_Heal_3 : Skill_Archetype
{
	Skill_Group_Heal_3()
	{
		Name 				= "#skill_group_heal_3_name";
		Description 		= "#skill_group_heal_3_description";
		Icon_Frame 			= "skill_group_heal_3";
		Cost 				= 5;
        Energy_Type         = Skill_Energy_Type.Enemy_Kills;
        Energy_Required     = 1000;
		Is_Passive		 	= false;
		Are_Children_Mutex 	= false;
		Parent_Name 		= "Skill_Group_Heal_2";
		Is_Team_Based		= true;
		Duration			= 0.0f;
