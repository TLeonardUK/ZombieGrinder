...
public class Skill_Group_Full_Ammo_1 : Skill_Archetype
{
	Skill_Group_Full_Ammo_1()
	{
		Name 				= "#skill_group_full_ammo_1_name";
		Description 		= "#skill_group_full_ammo_1_description";
		Icon_Frame 			= "skill_group_full_ammo_1";
		Cost 				= 3;
