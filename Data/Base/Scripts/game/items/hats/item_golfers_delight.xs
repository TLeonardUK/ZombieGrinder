...
public class Item_Golfers_Delight : Item_Archetype
{
	Item_Golfers_Delight()
	{
		Name 					= "#item_golfers_delight_name";
		Description 			= "#item_golfers_delight_description";
		Category				= "#item_golfers_delight_category";
		...
		Default_Tint			= Vec4(70, 160, 250, 255);
		
		Icon_Animation			= "item_hat_golfers_delight";
		Icon_Offset				= Vec2(32, 34);
		
		Is_Icon_Direction_Based	= true;
		Is_Icon_Overlay			= true;
		
		Combine_Name			= "Golfer's Delight";
		Combine_Group			= "Hats";
