...
public class Item_Colbydude : Item_Archetype
{
	Item_Colbydude()
	{
		Name 					= "#item_colbydude_name";
		Description 			= "#item_colbydude_description";
		Category				= "#item_colbydude_category";
		...
		Default_Tint			= Vec4(100, 30, 10, 255);
		
		Icon_Animation			= "item_hat_colbydude";
		Icon_Offset				= Vec2(32, 34);
		
		Is_Icon_Direction_Based	= true;
		Is_Icon_Overlay			= true;
		
		Combine_Name			= "Colbydude";
		Combine_Group			= "Hats";
