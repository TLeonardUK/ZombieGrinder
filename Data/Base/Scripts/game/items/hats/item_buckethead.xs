...
public class Item_Buckethead : Item_Archetype
{
	Item_Buckethead()
	{
		Name 					= "#item_buckethead_name";
		Description 			= "#item_buckethead_description";
		Category				= "#item_buckethead_category";
		...
		Default_Tint			= Vec4(0, 0, 160, 255);
		
		Icon_Animation			= "item_hat_buckethead";
		Icon_Offset				= Vec2(32, 34);
		
		Is_Icon_Direction_Based	= true;
		Is_Icon_Overlay			= true;
		
		Combine_Name			= "Bucket Head";
		Combine_Group			= "Hats";
