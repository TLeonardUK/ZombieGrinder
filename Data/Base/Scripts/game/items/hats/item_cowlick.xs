...
public class Item_Cowlick : Item_Archetype
{
	Item_Cowlick()
	{
		Name 					= "#item_cowlick_name";
		Description 			= "#item_cowlick_description";
		Category				= "#item_cowlick_category";
		...
		Default_Tint			= Vec4(130, 50, 50, 255);
		
		Icon_Animation			= "item_hat_cowlick";
		Icon_Offset				= Vec2(32, 34);
		
		Is_Icon_Direction_Based	= true;
		Is_Icon_Overlay			= true;
		
		Combine_Name			= "Cowlick";
		Combine_Group			= "Hats";
