...
public class Item_Froghat : Item_Archetype
{
	Item_Froghat()
	{
		Name 					= "#item_froghat_name";
		Description 			= "#item_froghat_description";
		Category				= "#item_froghat_category";
		
		Slot					= Item_Slot.Head;
		Cost					= 20000;
		Unlock_Criteria_Threshold			= 50;
