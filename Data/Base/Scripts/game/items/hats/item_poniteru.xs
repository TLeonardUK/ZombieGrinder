...
public class Item_Poniteru : Item_Archetype
{
	Item_Poniteru()
	{
		Name 					= "#item_poniteru_name";
		Description 			= "#item_poniteru_description";
		Category				= "#item_poniteru_category";
		...
		Default_Tint			= Vec4(255, 160, 230, 255);
		
		Icon_Animation			= "item_hat_poofy";
		Icon_Offset				= Vec2(32, 30);
		
		Is_Icon_Direction_Based	= true;
		Is_Icon_Overlay			= true;
		
		Combine_Name			= "Poofy Ponytail";
		Combine_Group			= "Hats";
