...
public class Item_Trucker : Item_Archetype
{
	Item_Trucker()
	{
		Name 					= "#item_trucker_name";
		Description 			= "#item_trucker_description";
		Category				= "#item_trucker_category";
