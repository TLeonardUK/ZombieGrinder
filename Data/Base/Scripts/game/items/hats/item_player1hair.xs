...
public class Item_Player1hair : Item_Archetype
{
	Item_Player1hair()
	{
		Name 					= "#item_player1hair_name";
		Description 			= "#item_player1hair_description";
		Category				= "#item_player1hair_category";
