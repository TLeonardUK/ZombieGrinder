...
public class Item_Pillager : Item_Archetype
{
	Item_Pillager()
	{
		Name 					= "#item_pillager_name";
		Description 			= "#item_pillager_description";
		Category				= "#item_pillager_category";
