...
public class Item_Bison_Cap : Item_Archetype
{
	Item_Bison_Cap()
	{
		Name 					= "#item_bison_cap_name";
		Description 			= "#item_bison_cap_description";
		Category				= "#item_bison_cap_category";
