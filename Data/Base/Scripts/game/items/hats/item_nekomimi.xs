...
public class Item_Nekomimi : Item_Archetype
{
	Item_Nekomimi()
	{
		Name 					= "#item_nekomimi_name";
		Description 			= "#item_nekomimi_description";
		Category				= "#item_nekomimi_category";
