...
public class Item_Foozball : Item_Archetype
{
	Item_Foozball()
	{
		Name 					= "#item_foozball_name";
		Description 			= "#item_foozball_description";
		Category				= "#item_foozball_category";
		
		Slot					= Item_Slot.Head;
		Cost					= 20000;
		Unlock_Criteria_Threshold			= 46;
