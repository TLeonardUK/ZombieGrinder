...
public class Item_Twintails : Item_Archetype
{
	Item_Twintails()
	{
		Name 					= "#item_twintails_name";
		Description 			= "#item_twintails_description";
		Category				= "#item_twintails_category";
		...
		Default_Tint			= Vec4(30, 180, 190, 255);
		
		Icon_Animation			= "item_hat_twintails";
		Icon_Offset				= Vec2(31, 40);
		
		Is_Icon_Direction_Based	= true;
		Is_Icon_Overlay			= true;
		
		Combine_Name			= "Twintails";
		Combine_Group			= "Hats";
