...
public class Item_Meguca : Item_Archetype
{
	Item_Meguca()
	{
		Name 					= "#item_meguca_name";
		Description 			= "#item_meguca_description";
		Category				= "#item_meguca_category";
		
		Slot					= Item_Slot.Head;
		Cost					= 20000;
		Unlock_Criteria_Threshold			= 54;
		...
		Default_Tint			= Vec4(255, 128, 192, 255);
		
		Icon_Animation			= "item_hat_meguca";
