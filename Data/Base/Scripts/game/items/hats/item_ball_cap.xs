...
public class Item_Ball_Cap : Item_Archetype
{
	Item_Ball_Cap()
	{
		Name 					= "#item_ball_cap_name";
		Description 			= "#item_ball_cap_description";
		Category				= "#item_ball_cap_category";
		...
		Default_Tint			= Vec4(240, 40, 75, 255);
		
		Icon_Animation			= "item_hat_ball_cap";
