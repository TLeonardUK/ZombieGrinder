...
public class Item_Slenderbag : Item_Archetype
{
	Item_Slenderbag()
	{
		Name 					= "#item_slenderbag_name";
		Description 			= "#item_slenderbag_description";
		Category				= "#item_slenderbag_category";
		
		Slot					= Item_Slot.Head;
		Cost					= 40000;
		Unlock_Criteria_Threshold			= 70;
		...
		Default_Tint			= Vec4(200, 50, 25, 255);
		
		Icon_Animation			= "item_hat_slenderbag";
		Icon_Offset				= Vec2(32, 34);
		
		Is_Icon_Direction_Based	= true;
		Is_Icon_Overlay			= true;
		
		Combine_Name			= "Selderbag";
		Combine_Group			= "Hats";
