...
public class Item_Turbo_Boy : Item_Archetype
{
	Item_Turbo_Boy()
	{
		Name 					= "#item_turbo_boy_name";
		Description 			= "#item_turbo_boy_description";
		Category				= "#item_turbo_boy_category";
		...
		Default_Tint			= Vec4(30, 30, 60, 255);
		
		Icon_Animation			= "item_hat_turbo_boy";
		Icon_Offset				= Vec2(32, 34);
		
		Is_Icon_Direction_Based	= true;
		Is_Icon_Overlay			= true;
		
		Combine_Name			= "Turbo Boy";
		Combine_Group			= "Hats";
