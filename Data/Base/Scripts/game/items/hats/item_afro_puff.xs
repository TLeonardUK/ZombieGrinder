...
public class Item_Afro_Puff : Item_Archetype
{
	Item_Afro_Puff()
	{
		Name 					= "#item_afro_puff_name";
		Description 			= "#item_afro_puff_description";
		Category				= "#item_afro_puff_category";
		...
		Default_Tint			= Vec4(80, 50, 60, 255);
		
		Icon_Animation			= "item_hat_afro_puff";
		Icon_Offset				= Vec2(32, 34);
		
		Is_Icon_Direction_Based	= true;
		Is_Icon_Overlay			= true;
		
		Combine_Name			= "Afro Puff";
		Combine_Group			= "Hats";
