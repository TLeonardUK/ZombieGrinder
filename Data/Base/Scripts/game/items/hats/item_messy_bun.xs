...
public class Item_Messy_Bun : Item_Archetype
{
	Item_Messy_Bun()
	{
		Name 					= "#item_messy_bun_name";
		Description 			= "#item_messy_bun_description";
		Category				= "#item_messy_bun_category";
		
		Slot					= Item_Slot.Head;
		Cost					= 20000;
		Unlock_Criteria_Threshold			= 57;
		...
		Default_Tint			= Vec4(40, 50, 90, 255);
		
		Icon_Animation			= "item_hat_messy_bun";
		Icon_Offset				= Vec2(32, 34);
		
		Is_Icon_Direction_Based	= true;
		Is_Icon_Overlay			= true;
		
		Combine_Name			= "Messy Bun";
		Combine_Group			= "Hats";
