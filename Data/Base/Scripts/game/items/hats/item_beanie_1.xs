...
public class Item_Beanie_1 : Item_Archetype
{
	Item_Beanie_1()
	{
		Name 					= "#item_beanie_1_name";
		Description 			= "#item_beanie_1_description";
		Category				= "#item_beanie_1_category";
		...
		Default_Tint			= Vec4(70, 70, 70, 255);
		
		Icon_Animation			= "item_hat_beanie_1";
		Icon_Offset				= Vec2(32, 35);
		
		Is_Icon_Direction_Based	= true;
		Is_Icon_Overlay			= true;
		
		Combine_Name			= "Beanie Type 1";
		Combine_Group			= "Hats";
