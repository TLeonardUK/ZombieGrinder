...
public class Item_Yayoi : Item_Archetype
{
	Item_Yayoi()
	{
		Name 					= "#item_yayoi_name";
		Description 			= "#item_yayoi_description";
		Category				= "#item_yayoi_category";
		...
		Default_Tint			= Vec4(190, 90, 30, 255);
		
		Icon_Animation			= "item_hat_yayoi";
