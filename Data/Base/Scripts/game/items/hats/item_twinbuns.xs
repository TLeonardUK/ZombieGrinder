...
public class Item_TwinBuns : Item_Archetype
{
	Item_TwinBuns()
	{
		Name 					= "#item_twinbuns_name";
		Description 			= "#item_twinbuns_description";
		Category				= "#item_twinbuns_category";
		
		Slot					= Item_Slot.Head;
		Cost					= 20000;
		Unlock_Criteria_Threshold			= 52;
		...
		Default_Tint			= Vec4(100, 210, 60, 255);
		
		Icon_Animation			= "item_hat_twinbuns";
		Icon_Offset				= Vec2(32, 34);
		
		Is_Icon_Direction_Based	= true;
		Is_Icon_Overlay			= true;
		
		Combine_Name			= "TwinBuns";
		Combine_Group			= "Hats";
