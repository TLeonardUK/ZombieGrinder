...
public class Item_Ryuko : Item_Archetype
{
	Item_Ryuko()
	{
		Name 					= "#item_ryuko_name";
		Description 			= "#item_ryuko_description";
		Category				= "#item_ryuko_category";
		
		Slot					= Item_Slot.Head;
		Cost					= 25000;
		Unlock_Criteria_Threshold			= 63;
		...
		Default_Tint			= Vec4(240, 30, 50, 255);
		
		Icon_Animation			= "item_hat_ryuko";
