...
public class Item_Flat_Top : Item_Archetype
{
	Item_Flat_Top()
	{
		Name 					= "#item_flat_top_name";
		Description 			= "#item_flat_top_description";
		Category				= "#item_flat_top_category";
		...
		Default_Tint			= Vec4(40, 40, 60, 255);
		
		Icon_Animation			= "item_hat_flat_top";
		Icon_Offset				= Vec2(32, 34);
		
		Is_Icon_Direction_Based	= true;
		Is_Icon_Overlay			= true;
		
		Combine_Name			= "Flat Top";
		Combine_Group			= "Hats";
