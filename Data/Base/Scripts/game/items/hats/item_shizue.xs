...
public class Item_Shizue : Item_Archetype
{
	Item_Shizue()
	{
		Name 					= "#item_shizue_name";
		Description 			= "#item_shizue_description";
		Category				= "#item_shizue_category";
