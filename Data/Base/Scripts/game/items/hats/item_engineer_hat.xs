...
public class Item_Engineer_Hat : Item_Archetype
{
	Item_Engineer_Hat()
	{
		Name 					= "#item_engineer_hat_name";
		Description 			= "#item_engineer_hat_description";
		Category				= "#item_engineer_hat_category";
		...
		Default_Tint			= Vec4(250, 250, 0, 255);
		
		Icon_Animation			= "item_hat_engineer_hat";
		Icon_Offset				= Vec2(32, 34);
		
		Is_Icon_Direction_Based	= true;
		Is_Icon_Overlay			= true;
		
		Combine_Name			= "Engineer Hat";
		Combine_Group			= "Hats";
