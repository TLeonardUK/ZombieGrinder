...
public class Item_Desgardes : Item_Archetype
{
	Item_Desgardes()
	{
		Name 					= "#item_desgardes_name";
		Description 			= "#item_desgardes_description";
		Category				= "#item_desgardes_category";
