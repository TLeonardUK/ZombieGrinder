...
public class Item_Presento : Item_Archetype
{
	Item_Presento()
	{
		Name 					= "#item_presento_name";
		Description 			= "#item_presento_description";
		Category				= "#item_presento_category";
		...
		Default_Tint			= Vec4(80, 170, 255, 255);
		
		Icon_Animation			= "item_hat_presento";
		Icon_Offset				= Vec2(32, 34);
		
		Is_Icon_Direction_Based	= true;
		Is_Icon_Overlay			= true;
		
		Combine_Name			= "Present!";
		Combine_Group			= "Hats";
