...
public class Item_Pompador : Item_Archetype
{
	Item_Pompador()
	{
		Name 					= "#item_pompador_name";
		Description 			= "#item_pompador_description";
		Category				= "#item_pompador_category";
		...
		Default_Tint			= Vec4(55, 55, 85, 255);
		
		Icon_Animation			= "item_hat_pompador";
		Icon_Offset				= Vec2(32, 35);
		
		Is_Icon_Direction_Based	= true;
		Is_Icon_Overlay			= true;
		
		Combine_Name			= "Modest puff";
		Combine_Group			= "Hats";
