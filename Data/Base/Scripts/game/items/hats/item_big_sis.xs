...
public class Item_Big_Sis : Item_Archetype
{
	Item_Big_Sis()
	{
		Name 					= "#item_big_sis_name";
		Description 			= "#item_big_sis_description";
		Category				= "#item_big_sis_category";
