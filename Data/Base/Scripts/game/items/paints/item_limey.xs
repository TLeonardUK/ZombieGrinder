...
public class Item_Limey : Item_Archetype
{
	Item_Limey()
	{
		Name 					= "#item_limey_name";
		Description 			= "#item_limey_description";
		Category				= "#item_limey_category";
		...
		Default_Tint			= Vec4(50, 205, 50, 255);
