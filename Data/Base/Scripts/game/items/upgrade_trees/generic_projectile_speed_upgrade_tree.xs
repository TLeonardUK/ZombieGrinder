...
public class Item_Generic_Projectile_Speed_Upgrade_Tree : Item_Upgrade_Tree
{
    Item_Generic_Projectile_Speed_Upgrade_Tree()
    {
        ...
        node.Add_ProjectileSpeed_Modifier(0.20f);
