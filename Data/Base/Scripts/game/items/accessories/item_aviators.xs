...
public class Item_Aviators : Item_Archetype
{
	Item_Aviators()
	{
		Name 					= "#item_aviators_name";
		Description 			= "#item_aviators_description";
		Category				= "#item_aviators_category";
