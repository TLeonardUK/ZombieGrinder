...
public class Item_Scouter : Item_Archetype
{
	Item_Scouter()
	{
		Name 					= "#item_scouter_name";
		Description 			= "#item_scouter_description";
		Category				= "#item_scouter_category";
		...
		Default_Tint			= Vec4(0, 255, 150, 255);
		
		Icon_Animation			= "item_accessory_scouter";
		Icon_Offset				= Vec2(32, 34);
		
		Is_Icon_Direction_Based	= true;
		Is_Icon_Overlay			= true;
		
		Combine_Name			= "Scouter";
		Combine_Group			= "Hats";
