...
public class Item_Headset : Item_Archetype
{
	Item_Headset()
	{
		Name 					= "#item_headset_name";
		Description 			= "#item_headset_description";
		Category				= "#item_headset_category";
		...
		Default_Tint			= Vec4(0, 183, 239, 255);
		
		Icon_Animation			= "item_accessory_headset";
		Icon_Offset				= Vec2(32, 40);
		
		Is_Icon_Direction_Based	= true;
		Is_Icon_Overlay			= true;
		
		Combine_Name			= "Headset";
		Combine_Group			= "Hats";
