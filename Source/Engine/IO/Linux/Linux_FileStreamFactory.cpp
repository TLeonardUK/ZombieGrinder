...
Stream*	Linux_FileStreamFactory::Try_Open(const char* url, StreamMode::Type mode)
{
	// See if file exists.
	...
	return new Linux_FileStream(handle);
}

u64 Linux_FileStreamFactory::Try_Get_Last_Modified(const char* url)
{
