...
public:
    ...
    */
    ...
    explicit GenericValue(uint64_t len64) RAPIDJSON_NOEXCEPT : data_(), flags_(kNumberUint64Flag) {
        data_.n.len64 = len64;
        if (!(len64 & RAPIDJSON_UINT64_C2(0x80000000, 0x00000000)))
            flags_ |= kInt64Flag;
        if (!(len64 & RAPIDJSON_UINT64_C2(0xFFFFFFFF, 0x00000000)))
            flags_ |= kUintFlag;
        if (!(len64 & RAPIDJSON_UINT64_C2(0xFFFFFFFF, 0x80000000)))
            flags_ |= kIntFlag;
    }
    ...
    bool operator==(const GenericValue<Encoding, SourceAllocator>& rhs) const {
        ...
        case kNumberType:
            if (IsDouble() || rhs.IsDouble()) {
                ...
                return data_.n.len64 == rhs.data_.n.len64;
    ...
    */
    ...
    uint64_t GetUint64() const  { RAPIDJSON_ASSERT(flags_ & kUint64Flag); return data_.n.len64; }
    ...
    double GetDouble() const {
        ...
        RAPIDJSON_ASSERT((flags_ & kUint64Flag) != 0);  return (double)data_.n.len64; // uint64_t -> double (may lose precision)
    }

    GenericValue& SetInt(int i)             { this->~GenericValue(); new (this) GenericValue(i);    return *this; }
    GenericValue& SetUint(unsigned u)       { this->~GenericValue(); new (this) GenericValue(u);    return *this; }
    GenericValue& SetInt64(int64_t i64)     { this->~GenericValue(); new (this) GenericValue(i64);  return *this; }
    GenericValue& SetUint64(uint64_t len64)   { this->~GenericValue(); new (this) GenericValue(len64);  return *this; }
    ...
    */
    ...
    bool Accept(Handler& handler) const {
        ...
        default:
            ...
            else if (IsUint64())    return handler.Uint64(data_.n.len64);
